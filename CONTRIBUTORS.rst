...
The *universe.hashicorp* project is released under the licensing terms of the MIT
...
included within the *universe.hashicorp* project but does not fall under the terms
stated above.
...
The below-signed are contributors to the project named *universe.hashicorp*. Each
...
- Jimmy Thrasibule <dev@jimmy.lt>, 2023/08/27
